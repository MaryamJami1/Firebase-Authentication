  ...
  import { getFirestore,collection, addDoc, doc, setDoc, getDoc,updateDoc, serverTimestamp, query, where,getDocs,onSnapshot,orderBy } from "https://www.gstatic.com/firebasejs/11.0.1/firebase-firestore.js";
...
export {getAuth, createUserWithEmailAndPassword, signInWithEmailAndPassword, sendEmailVerification, signOut, onAuthStateChanged, updateProfile, signInWithPopup, GoogleAuthProvider, collection, addDoc, doc, setDoc, db, getDoc,updateDoc, serverTimestamp, query, where,getDocs,onSnapshot,orderBy}